...
// regressions 
	...
	// note: we have to exclude the "rd_coworker_fe_m == 0" restriction (no raided worker -> no FE for them)
	...
	esttab c1_spv_5 c2_spv_5 c3_spv_5 c4_spv_5 c5_spv_5 using "${results}/pred5_zero.tex", booktabs  /// 
		replace compress noconstant nomtitles nogap collabels(none) label /// 
