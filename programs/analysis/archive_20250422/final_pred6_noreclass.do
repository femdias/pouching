...
// regressions	
	...
	eststo c6_spvs_6: reg pc_wage_d d_size_w_ln d_growth_w    c.rd_coworker_fe##c.lnraid ///
			pc_wage_o_l1 $mgr ///
			if $raidcond & (spv==2 & waged_svpemp<. & waged_svpemp>=1), rob
	...
	eststo c6_epvs_6: reg pc_wage_d d_size_w_ln d_growth_w    c.rd_coworker_fe##c.lnraid ///
			pc_wage_o_l1 $mgr ///
			if $raidcond & (spv==3 & waged_empspv<. & waged_empspv>=1) , rob
	...
	esttab c0_spv_6 c3_spv_6 c4_spv_6 c5_spv_6 c6_spv_6 using "${results}/pred6_noreclass.tex", booktabs  /// 
		replace compress noconstant nomtitles nogap collabels(none) label /// 
