...
*--------------------------*
* ANALYSIS (INCLUDING ZERO)
*--------------------------*

// global
global mgr "pc_exp_ln pc_exp_m pc_fe pc_fe_m"
global spvcond "(spv==1 | (spv==2 & waged_svpemp==10) | (spv==3 & waged_empspv==10)) "
global raidcond "rd_coworker_n>=0 & pc_ym >= ym(2010,1)" // we have to exclude the "rd_coworker_fe_m == 0" restriction (no raided worker -> no FE for them)
...
// regressions	
	...
	esttab c0_spv_4 c3_spv_4 c4_spv_4 c5_spv_4 using "${results}/pred4_zero.tex", booktabs  /// 
		replace compress noconstant nomtitles nogap collabels(none) label /// 
