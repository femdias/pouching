...
// cleaning and organizing this data set

forvalues ym = 516/695 {			
	
	use "${data}/rais_m/rais_m`ym'", clear
	
	drop emp dir_temp n_emp_plant_year n_dir_plant_year p95 dirinc_temp n_dirinc_plant_year ///
		dirinc spv_temp n_spv_plant_year estab_size_dec31
	
	cap label var cpf 			"Worker ID (CPF)"
	cap label var ym 			"Year-Month"
	cap label var year 			"Year"
	cap label var month 			"Month"
	cap label var plant_id 			"Plant ID (CNPJ)"
	cap label var muni 			"Plant Municipality"
	cap label var contract_type 		"Contract Type"
	cap label var type_of_hire 		"Type of Hire"
	cap label var cause_of_sep		"Cause of Separation"
	cap label var sep_month 		"Month of Separation"
	cap label var occup_cbo2002 		"Occup. Code (CBO 2002)"
	cap label var educ 			"Education"
	cap label var gender 			"Gender"
	cap label var race 			"Race"
	cap label var earn_avg_month_nom 	"Avg. Monthly Earnings (Nominal)"
	cap label var tenure_months 		"Tenure (in Months)"
	cap label var salary_type		"Salary Type"
	cap label var contract_salary 		"Contractual Salary"
	cap label var num_hours_contracted 	"Contracted Weekly Hours"
	cap label var cnae20_subclass 		"Industry Subclass (CNAE 2.0)"
	cap label var cnae20_class 		"Industry Classs (CNAE 2.0)"
	cap label var legal_nature 		"Legal Nature"
	cap label var hire_year 		"Hire Year"
	cap label var hire_month 		"Hire Month"
	cap label var hire_day			"Hire Day"
	cap label var birth_year 		"Birth Year"
	cap label var age 			"Age"
	cap label var educ_years 		"Education (in Years)"
	cap label var hire_date 		"Hire Date"
	cap label var sep_date 			"Date of Separation"
	cap label var firm_id 			"Firm ID (CNPJ)"
	cap label var occ_1d 			"1-Digit Occup. Code (CBO 2002)"
	cap label var occ_3d 			"3-Digit Occup. Code (CBO 2002)"
	cap label var gov 			"Government (Non-Private) Firm"
	cap label var n_emp 			"Total Employment (Plant Level)"
	cap label var n_emp_firm 		"Total Employment (Firm Level)"
	cap label var dir 			"Worker is a Director (Occup. Code)"
	cap label var dir5 			"Worker is a Director (Occup. Code + P95)"
	cap label var spv 			"Worker is a Supervisor"
	
	order cpf ym year month plant_id firm_id muni contract_type type_of_hire hire_date ///
		hire_year hire_month hire_day tenure_months occup_cbo2002 occ_1d occ_3d ///
		dir dir5 spv cause_of_sep sep_month sep_date educ educ_years gender ///
		race birth_year age earn_avg_month_nom contract_salary salary_type ///
		num_hours_contracted legal_nature gov ///
		n_emp n_emp_firm
	...
	// TO DO HERE: ADD REAL WAGES, USING 2017 AS THE BASE YEAR
	// BECAUSE 2017 IS THE YEAR WE'RE USING WHEN ESTIMATING AKM EFFECTS
	
	// I ALSO HAVE TO CORRECT THE CAUSE OF SEPARATION
