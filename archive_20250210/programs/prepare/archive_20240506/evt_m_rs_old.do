...
use "output/data/rais_m_rs", clear	
	...
	gen pc_dir = (dir == 1 & criteria1 == 1 & criteria2 == 1 & criteria3 == 1 & criteria4 == 1 & ///
		criteria5 == 1 & criteria6 == 1 & criteria7 == 1)
		
	// director (1xx | top 5%) is poached --> 2,407 events
	gen pc_dir5 = (dir5 == 1 & criteria1 == 1 & criteria2 == 1 & criteria3 == 1 & criteria4 == 1 & ///
		criteria5 == 1 & criteria6 == 1 & criteria7 == 1)
		
	// supervisor (xx0) is poached --> 1,251 events
	gen pc_spv = (spv == 1 & criteria1 == 1 & criteria2 == 1 & criteria3 == 1 & criteria4 == 1 & ///
		criteria5 == 1 & criteria6 == 1 & criteria7 == 1)
		
	// employee (dir == 0 & spv == 0) is poached --> 35,054 events	
	gen pc_emp = (dir == 0 & L.spv == 0 & criteria1 == 1 & criteria2 == 1 & criteria3 == 1 & ///
	...
	save "output/data/evt_m_rs_`e'_old", replace
	
	}
	
	use "output/data/evt_m_rs_dir_old", clear // xx events
	use "output/data/evt_m_rs_dir5_old", clear // xx events
	use "output/data/evt_m_rs_spv_old", clear // xx events
	...
	foreach e in dir dir5 spv {
		...
		append using "output/data/evt_m_rs_`e'_old"
		keep d_plant
		duplicates drop
	...
	save "output/data/evt_m_rs_emp_old", replace
