...
// combining events and keeping what we need
	...
	reshape long fe_firm fe_avgworker size_w rd_coworker_wage rd_coworker_wage_lvl rd_cw_wage_w manu serv ret oth pc_wage pc_wage_lvl pc_wage_w pc_age pc_exp pc_fe, ///
	...
	estpost su  fe_firm fe_avgworker size_w rd_cw_wage_w pc_wage_w pc_age pc_exp pc_fe   if or_dest==2, d
	matrix est2 = e(p10)
	
	estpost su  fe_firm fe_avgworker size_w rd_cw_wage_w pc_wage_w   if or_dest==1, d
	matrix est1 = e(p10)
	
	estpost su  fe_firm fe_avgworker size_w rd_cw_wage_w pc_wage_w pc_age pc_exp pc_fe, d
	estadd matrix est2
	estadd matrix est1
	estadd scalar n = `n'
	est store p10
	...
	estpost su  fe_firm fe_avgworker size_w rd_cw_wage_w pc_wage_w pc_age pc_exp pc_fe manu serv ret oth  if or_dest==2, d
	matrix est2 = e(mean)
	
	estpost su  fe_firm fe_avgworker size_w rd_cw_wage_w pc_wage_w manu serv ret oth  if or_dest==1, d
	matrix est1 = e(mean)
	
	estpost su  fe_firm fe_avgworker size_w rd_cw_wage_w pc_wage_w pc_age pc_exp pc_fe manu serv ret oth, d
	estadd matrix est2
	estadd matrix est1
	est store mean
	...
	estpost ttest  fe_firm fe_avgworker size_w rd_cw_wage_w manu serv ret oth pc_wage_w, by(or_dest) unequal
	est store diff
